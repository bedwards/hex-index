---
title: "8 big ideas for 2026 (and more trends to watch)"
author: "a16z crypto"
publication: "web3 with a16z"
publication_slug: "a16zcrypto"
published_at: "2026-01-03T15:56:35.000Z"
source_url: "https://a16zcrypto.substack.com/p/8-big-ideas-for-2026-and-more-trends"
word_count: 2511
estimated_read_time: 13
---

a16z recently released its [list](https://www.a16z.news/p/big-ideas-2026-part-1) of “big ideas” tech builders may tackle in the year ahead, according to partners across the Apps, American Dynamism, Bio, Crypto, Growth, Infra, and Speedrun teams.

So below is a selection of some of the big ideas from various crypto team members (plus a few guest contributors) for what’s ahead — on topics ranging from agents and AI; stablecoins, tokenization, and finance; privacy and security; and prediction markets and other applications. For more of what we’re excited about for 2026, read the [full post](https://a16zcrypto.com/posts/article/big-ideas-things-excited-about-crypto-2026/).
...
![BigIdeas_Insets_4-Trading as a way station.jpg](https://substackcdn.com/image/fetch/$s_!5Egw!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fa9482874-e8aa-4438-9189-796a37c19151_800x450.jpeg "BigIdeas_Insets_4-Trading as a way station.jpg")



](https://substackcdn.com/image/fetch/$s_!5Egw!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fa9482874-e8aa-4438-9189-796a37c19151_800x450.jpeg)
...
![BigIdeas_Insets_3_tokenization.jpg](https://substackcdn.com/image/fetch/$s_!fQkp!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F3ef79a33-ea33-470d-9dff-f73b76a614bb_800x450.jpeg "BigIdeas_Insets_3_tokenization.jpg")



](https://substackcdn.com/image/fetch/$s_!fQkp!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F3ef79a33-ea33-470d-9dff-f73b76a614bb_800x450.jpeg)
...
It all comes down to the question of “[perpification vs. tokenization](https://www.youtube.com/watch?v=xQttYSnu1nk)”; but either way, we should see more crypto-native RWA tokenization in the coming year.
...
That’s where stablecoins come in. Not only were the [last couple years](https://a16zcrypto.com/posts/series/state-of-crypto/) when stablecoins found product-market fit and hit the mainstream, but this year, TradFi institutions [embraced them at a whole new level](https://a16zcrypto.com/posts/article/making-sense-of-stablecoin-news/). Stablecoins, tokenized deposits, tokenized treasuries, and onchain bonds allow banks, fintechs, and financial institutions to build new products and serve new customers. More importantly, they can do this without forcing these organizations to rewrite their legacy systems — systems that, while aging, have run reliably for decades. Stablecoins thus provide a new way for institutions to innovate.
...
![BigIdeas_Insets_11_AI for substantive.jpg](https://substackcdn.com/image/fetch/$s_!iYF_!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F1a7962e4-4e61-4fd8-8771-5097b204b32c_800x450.jpeg "BigIdeas_Insets_11_AI for substantive.jpg")



](https://substackcdn.com/image/fetch/$s_!iYF_!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F1a7962e4-4e61-4fd8-8771-5097b204b32c_800x450.jpeg)

### 4\. We’ll use AI for substantive research tasks

As a mathematical economist, it was difficult to get consumer AI models to even understand my work process back in January this year; yet by November, I could give models abstract instructions in the same way I would to a doctoral student… and they sometimes return novel and correctly executed answers. Beyond my experience here, we’re starting to see AIs used for research more broadly — especially in reasoning domains, where models are now directly aiding [discovery](https://blog.google/technology/ai/google-gemma-ai-cancer-therapy-discovery/) and also [autonomously solving Putnam problems](https://x.com/i/status/1997767850279440715) (perhaps the world’s hardest university-level math exam).
...
Reasoning in this manner will require a new style of AI workflow — not just agent-to-agent, but more agent-*wrapping*\-agent — where layers of models help the researcher evaluate the earlier models’ approaches and [successively synthesize](https://www.refine.ink/) the wheat from the chaff. I’ve been using this approach to [write papers](https://arxiv.org/abs/2512.06446), while others are conducting [patent searches](https://www.pymnts.com/artificial-intelligence-2/2025/agentic-ai-takes-over-patent-search/), inventing new [forms of art](https://diid.art/automata), or (unfortunately) finding [novel smart contract attacks](https://www.coindesk.com/tech/2025/12/02/anthropic-research-shows-ai-agents-are-closing-in-on-real-defi-attack-capability).

However: Operating ensembles of wrapped reasoning agents for research will require [better interoperability](https://a16zcrypto.com/posts/article/ai-crypto-crossovers/#1-persistent-data-and-context-in-ai-interactions) between models, along with a way to [recognize and properly compensate](https://a16zcrypto.com/posts/article/ai-crypto-crossovers/#7-micropayments-that-support-revenue-sharing) each model’s contribution — both problems crypto can help solve.
...
![BigIdeas_Insets_1_Privacy.jpg](https://substackcdn.com/image/fetch/$s_!RUyt!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F4a4cb026-5a81-4c51-af72-788dfe5c6ff9_800x450.jpeg "BigIdeas_Insets_1_Privacy.jpg")



](https://substackcdn.com/image/fetch/$s_!RUyt!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F4a4cb026-5a81-4c51-af72-788dfe5c6ff9_800x450.jpeg)
...
![BigIdeas_Insets_8-messaging isn’t just quantum-resistant.jpg](https://substackcdn.com/image/fetch/$s_!Wl0d!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F89b56af3-7c94-4e09-98c4-364486c801c0_800x450.jpeg "BigIdeas_Insets_8-messaging isn’t just quantum-resistant.jpg")



](https://substackcdn.com/image/fetch/$s_!Wl0d!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F89b56af3-7c94-4e09-98c4-364486c801c0_800x450.jpeg)
...
First, many more contracts will be listed. This means we’ll be able to access real-time odds not just for major elections or geopolitical events, but for all kinds of in-the-weeds outcomes and complex, intersecting events. As these new contracts surface more information and become part of the news ecosystem ([already happening](https://a16zcrypto.substack.com/p/everyones-wrong-about-quantum-computing)), they’ll raise important societal questions about how we balance the value of this information and how to better design them so they are more transparent, auditable, and more — which is possible with crypto.

To handle the much larger volume of contracts, we’ll need new ways of aligning on truth to resolve the contracts. Centralized platform resolution (did a given event actually happen? how do we confirm it?) is important, but disputed cases like the [Zelensky suit market](https://www.wired.com/story/volodymyr-zelensky-suit-polymarket-rebellion/) and the [Venezuelan election market](https://ar.usembassy.gov/assessing-the-results-of-venezuelas-presidential-election/) show the limits. To address these edge cases and help prediction markets scale to more useful applications, new kinds of decentralized governance and LLM oracles can help determine truth for contested outcomes.
...
For more ideas we’re excited about, [see the full post](https://a16zcrypto.com/posts/article/big-ideas-things-excited-about-crypto-2026/).

[

![](https://substackcdn.com/image/fetch/$s_!N4Np!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F0b507069-7a02-44bb-842d-cf252cfcf8bf_1920x1080.jpeg)
