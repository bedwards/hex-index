...
published_at: "2026-01-27T17:03:36.000Z"
source_url: "https://newsletter.pragmaticengineer.com/p/ai-first-makeover-craft"
word_count: 3600
estimated_read_time: 18
---

*Before we start: Elin and I are running a survey on AI usage by software engineers and engineering teams. If you have 10 minutes, please consider taking part by **[filling out this survey](https://www.surveymonkey.com/r/tpe-ai-survey-2026)**. This time, we’ll share an extra, longer report – similar to [this one on MCP](https://www.pragmaticurl.com/mcp-report) – with everyone who does so. The industry is changing fast, and we’re aiming to provide thorough, grounded analysis of what’s going on. Thank you!*
...
**The visual agentic tool (Craft Agents) that changed how Craft’s non-engineering teams work, and how software is built there. It’s [free and open source](https://agents.craft.do/)**
...
**Craft Terminal: a wrapper to connect Craft Docs as a data source to Claude Code**
...
![](https://substackcdn.com/image/fetch/$s_!m062!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fdc5728e8-694d-4d14-b907-a016e618e4b0_1200x713.png)



](https://substackcdn.com/image/fetch/$s_!m062!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fdc5728e8-694d-4d14-b907-a016e618e4b0_1200x713.png)
**Craft Agents. [Download](https://agents.craft.do/) as a pre-built app, install [via command line](https://github.com/lukilabs/craft-agents-oss), or [get the source from GitHub](https://github.com/lukilabs/craft-agents-oss)**
...
**Kicking off parallel agents helps complete parallelizable tasks faster, like triaging inbound tickets. See the text “Let me spawn worker agents to process them in batches of 3.”**
...
**Report generated by the agent when triage is complete**
...
**Defining a skill in Craft Agents. Note other skills defined by the Craft team in the left column**
...
*M*odifying Craft Agents to use Projects via prompts. New open source “remixing” with AI? Source: [Lisa Skorobogatova](https://x.com/lisascorexx/status/2014376300559864256)**
...
[Read more](https://newsletter.pragmaticengineer.com/p/ai-first-makeover-craft)