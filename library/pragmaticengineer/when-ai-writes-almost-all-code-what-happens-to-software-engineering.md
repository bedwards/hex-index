...
published_at: "2026-01-06T17:41:49.000Z"
...
4.  **The good: software** ***engineers*** **more valuable than before.** Tech lead traits in more demand, being more “product-minded” to be a baseline at startups, and being a solid software engineer and not just a “coder” will be more sought-after than before.
...
*Longtime readers may recall Malte from his [reflections on 20 years in software engineering, including 11 at Google.](https://newsletter.pragmaticengineer.com/p/20-years-of-software-engineering)*
...
*We previously did a deepdive on [how Claude Code was built](https://newsletter.pragmaticengineer.com/p/how-claude-code-is-built) with Boris and other founding members of the team.*

## 2\. Why now?

Model releases in November and December seem like the tipping point where AI got *really* good at generating code:
...
*The first-ever The Pragmatic Engineer Podcast episode was with Simon, fittingly entitled [AI tools for software engineers, but without the hype](https://newsletter.pragmaticengineer.com/p/ai-tools-for-software-engineers-simon-willison) – and Simon continues to live up to that sentiment.*

### Wild prediction coming true?
...
When the code is not how I want it, I do more prompting to get the LLM to fix it. Like Boris, I’ve ceased writing code by hand because I don’t *have* to do it, and the models seem capable enough. I can still do it, but it’s simply faster to leave it to the model.

Even for code that I know well enough and can navigate in my IDE, I’ve noticed that prompting the agent can get edits done just as quickly as I would do it, if not faster. Nonetheless, I do find myself going to the IDE as I like to *know* that I can do the work.
...
## 3\. The bad: declining value of expertise
...
**Shaq vibe coding with no development experience. The apps were prototypes at best. Source: [Replit](https://www.youtube.com/shorts/fbDJ6JXtoFQ)**
...
## 4\. The good: software engineers more valuable than before

[Read more](https://newsletter.pragmaticengineer.com/p/when-ai-writes-almost-all-code-what)