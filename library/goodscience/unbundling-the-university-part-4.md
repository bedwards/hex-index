---
title: "Unbundling the University, Part 4"
author: "Stuart Buck"
publication: ""
publication_slug: "goodscience"
published_at: "2025-07-07T11:19:18.000Z"
source_url: "https://goodscience.substack.com/p/unbundling-the-university-part-4"
word_count: 3381
...
*This is the fourth and final installment of Ben Reinhardt’s monograph on Unbundling the University. For the first three parts, see [here](https://goodscience.substack.com/p/unbundling-the-university-part-1), [here](https://goodscience.substack.com/p/unbundling-the-university-part-2), and [here](https://goodscience.substack.com/p/unbundling-the-university-part-3). For more of Ben’s work, check out the [Speculative Technologies site](https://spec.tech/).*

\*\*\*

# **3\. Universities need to be unbundled**
...
This isn’t a call to burn everything down: the university should be one of those competing institutions! [Academia is uniquely good at some things.](https://blog.spec.tech/p/in-defense-of-academia) More institutional competition would put pressure on academia to be the best that it can be, playing to its strengths and shedding its accumulated encrustations.
...
-   [Experiment with how universities are run.](https://x.com/Scholars_Stage/status/1744185779511791643?s=20)
...
We’re not going to build this capacity and manufacture things cost-effectively in the US by putting up tariffs and otherwise trying to out-China China. Even ignoring their heavy government subsidies, they’ve gone too far down the [learning curves](https://en.wikipedia.org/wiki/Learning_curve) of conventional ways of manufacturing things.

The way that we’re going to rebuild manufacturing capacity in the US is the same way you disrupt an entrenched player: by changing the game and creating a new paradigm. Changing the game enabled [minimills to displace big steel factories](https://www.npr.org/2024/03/20/1197958509/steel-mini-mill-nucor-bethlehem) as dominant steel producers, cell phones to displace desktops as the most prevalent computing devices, and submarines and aircraft carriers to displace battleships as the most dangerous things on the ocean.
...
-   [Experimentation with state universities](https://x.com/Scholars_Stage/status/1744185779511791643)
    
-   [Industry schools/skill factories](https://x.com/codyaims/status/1723206795316121969)
    
-   [Science houses](https://www.experimental-history.com/p/lets-build-a-fleet-and-change-the)
    
-   [Focused research organizations](https://www.convergentresearch.org/about-fros)
    
-   [Alternative credentialing](https://blogs.microsoft.com/blog/2020/06/30/microsoft-launches-initiative-to-help-25-million-people-worldwide-acquire-the-digital-skills-needed-in-a-covid-19-economy/)
...
1.  [The DDOS Attack of Academic Bullshit](https://www.benlandautaylor.com/p/the-ddos-attack-of-academic-bullshit)
    
2.  [Caltech Faculty Letter on the State of the Undergrads](https://tech.caltech.edu/2024/04/26/letter-sat-reinstatement/#faculty-petition) ( [Archived version)](https://archive.ph/1fQLi)
    
3.  [A Vision of Metascience](https://scienceplusplus.org/metascience/index.html)
    
4.  [A Thread on Experimenting with State Universities](https://x.com/Scholars_Stage/status/1744185779511791643)
    
5.  [Arnold Kling’s How to Fix Higher Education](https://open.substack.com/pub/arnoldkling/p/how-to-fix-higher-education)
    
6.  [Two Essays on Boston University’s Decision to Pause PhD Admissions](https://www.mindingthecampus.org/2024/11/29/two-essays-on-boston-universitys-decision-to-pause-admissions-to-doctoral-programs/)
    
7.  [A History of the University in Europe Volume III](https://www.amazon.com/History-University-Europe-Universities-Nineteenth/dp/0521361079)
    
8.  [Creating the Market University](https://www.amazon.com/Creating-Market-University-Academic-Economic/dp/0691147086?crid=IN4WJE0J8NJ&dib=eyJ2IjoiMSJ9.6BHUn1Az5JxvX4EFcqgptmdgz2TgCrOZRawWtLBvi73AnFJm1Y-810M-PpLZb_npm7T1bpMO_LoAQzhqGaTDJhY-xFoz9cuA6yUfYzZX_gUGyTssedBlsSVS7vaTxXaWQBdSxNVTX0HQu8T2NPcp7mdlqMpBltww7vBsj_erAT6HrMfMgTdxx63kyTZ35r9EX7tZrdeeFOWHpy_LmH7vepDDbjVvBUlwl0yEgcyfQc8.zqoTt34suJ12NAXF9qL7D9n6JOJBC9BPa1vhfg89dDM&dib_tag=se&keywords=creating+the+market+university&qid=1736440444&sprefix=Creating+the+Market+University%2Caps%2C112&sr=8-1)
    
9.  [An Interview with the Stanford President,](https://stanfordreview.org/levin-interview/) in particular this bit:
    

[

![alt_text](https://substackcdn.com/image/fetch/$s_!_Adk!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fce8183aa-94c8-4ffc-a331-868b28864c1b_1378x548.png "image_tooltip")



](https://substackcdn.com/image/fetch/$s_!_Adk!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fce8183aa-94c8-4ffc-a331-868b28864c1b_1378x548.png)

10.  [Dropping College Enrollment](https://www.latintimes.com/educators-sound-alarm-college-enrollment-drops-very-large-very-discouraging-amount-568456)
     
11.  [Data on R&D Expenditures in the US](https://ncses.nsf.gov/pubs/nsf24307)
     
12.  [An article on professors leaving academia to do biomedical research](https://www.harvardmagazine.com/2025/01/harvard-academia-to-biomedical-research?mc_cid=0a0ed5ef71)
...
1.  Some fields have a custom of using an asterisk to denote “co-first authors,” but everybody knows most of the time one person gets most of the credit and physically, one name will always be first. [↩︎](https://www.unbundle-the-university.com/#fnref1)
    
2.  This is a thing that China figured out centuries earlier. [↩︎](https://www.unbundle-the-university.com/#fnref2)
    
3.  While Humboldt’s ideas were formative to the Prussian University system (and our entire modern university system), some of his ideas (like complete academic freedom) were conveniently left out of the implementation. [↩︎](https://www.unbundle-the-university.com/#fnref3)
    
4.  Imagine if people so explicitly chalked national loss or victory up to education systems today! [↩︎](https://www.unbundle-the-university.com/#fnref4)
    
5.  Anecdotally, the most common response to “I’m a professor” is “oh, what do you teach?” [↩︎](https://www.unbundle-the-university.com/#fnref5)
    
6.  Frustratingly there is little actual hard data on the breakdown of university revenues and funding sources for research before 1950: a project for an enterprising metascientist! [↩︎](https://www.unbundle-the-university.com/#fnref6)
    
7.  Large academic labs can have upwards of 40 or 50 people