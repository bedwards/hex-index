---
title: "Import AI 447: The AGI economy; testing AIs with generated games; and agent ecologies "
author: "Jack Clark"
publication: "Import AI"
publication_slug: "importai"
published_at: "2026-03-02T13:45:27.000Z"
...
**Read more:** [Some Simple Economics of AGI (arXiv)](https://arxiv.org/abs/2602.20946).  
...
**You can view the conversation here**: [“How Fast Will A.I. Agents Rip Through the Economy? | The Ezra Klein Show” (YouTube).](https://www.youtube.com/watch?v=lIJelwO8yHQ)  
...
**Read more:** [LLM Novice Uplift on Dual-Use, In Silico Biology Tasks (arXiv)](https://arxiv.org/abs/2602.23329).  
...
**Read more**: [AI Gamestore: Scalable, Open-Ended Evaluation of Machine General Intelligence with Human Games (arXiv)](https://arxiv.org/abs/2602.17594).  
**Try out some of the games** at [the official site (AI Gamestore)](http://aigamestore.org).  
...
**Read more:** [The Physical Intelligence Layer (Physical Intelligence, blog)](https://www.pi.website/blog/partner?v=1).  
...
-   Run AI agents using OpenClaw, hosted on an isolated virtual machine on [Fly.io](http://fly.io) using ClawnBoard. Each agent was given 20GB of storage and runs 24/7.
...
**Read more**: [Agents of Chaos (arXiv)](https://arxiv.org/abs/2602.20021).  
**Check out more of the results** at the [Agents of Chaos official website](https://agentsofchaos.baulab.info/).  
