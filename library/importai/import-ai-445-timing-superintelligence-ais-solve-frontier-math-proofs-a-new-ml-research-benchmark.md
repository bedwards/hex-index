---
title: "Import AI 445: Timing superintelligence; AIs solve frontier math proofs; a new ML research benchmark"
author: "Jack Clark"
publication: "Import AI"
publication_slug: "importai"
published_at: "2026-02-16T14:01:19.000Z"
...
**Read more:** [AI and the Economics of the Human Touch (Agglomerations, Substack)](https://agglomerations.substack.com/p/economics-of-the-human?r=2bcce&utm_medium=ios&shareImageVariant=overlay&triedRedirect=true).  
...
**Read more**: [Kunlun: Establishing Scaling Laws for Massive-Scale Recommendation Systems through Unified Architecture Design (arXiv)](https://arxiv.org/abs/2602.10016).  
...
**Read more:** [Optimal Timing for Superintelligence (Nick Bostrom, PDF)](https://nickbostrom.com/optimal.pdf).  
...
**Results:** Real problems, crappy models: This is a somewhat perplexing benchmark - the tasks are interesting and wrap in a lot of complexity. But the paper only tests out relatively bad models, such as the Code World Model, o3-mini, gpt-oss-20b, gpt-oss-120b, GPT-4o, and Devstral-Small 24B. This is a very funny set of models, and none of them are true frontier ones - one of the paper authors wrote on twitter “[this took some time to get out](https://x.com/j_foerst/status/2021524537662210204)“, so this could just be an artifact of slow publishing timelines.  
...
**Read more**: [AIRS-Bench: a Suite of Tasks for Frontier AI Research Science Agents (arXiv)](https://arxiv.org/abs/2602.06855).  
...
**Who did it:** First Proof was built by researchers with Stanford, Columbia, EPFL, Imperial College, University of Texas at Austin, [MathSci.ai](http://mathsci.ai), Aarhus University, Yale University, University of California at Berkeley, University of Texas at Austin, University of Chicago, and Harvard University.  
...
**Read more:** [First Proof (arXiv)](https://arxiv.org/abs/2602.05192).  
**Find out more** at [the website (First Proof)](https://1stproof.org/).  
