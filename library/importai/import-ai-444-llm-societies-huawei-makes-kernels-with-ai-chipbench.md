...
published_at: "2026-02-09T14:03:34.000Z"
...
**Read more**: [Reasoning Models Generate Societies of Thought (arXiv)](https://arxiv.org/abs/2601.10825).  
...
**Read more:** [ChipBench: A Next-Step Benchmark for Evaluating LLM Performance in AI-Aided Chip Design (arXiv)](https://arxiv.org/abs/2601.21448).  
**Get the [code](https://github.com/zhongkaiyu/ChipBench)** [for ChipBench here (GitHub)](https://github.com/zhongkaiyu/ChipBench).  
...
**Read more:** [Semi-Autonomous Mathematics Discovery with Gemini: A Case Study on the Erdős Problems (arXiv)](https://arxiv.org/abs/2601.22401).  
...
**Read more**: [AscendCraft: Automatic Ascend NPU Kernel Generation via DSL-Guided Transcompilation (arXiv)](https://arxiv.org/abs/2601.22760).  
