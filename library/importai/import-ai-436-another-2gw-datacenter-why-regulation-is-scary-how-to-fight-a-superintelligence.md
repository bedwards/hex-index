---
title: "Import AI 436: Another 2GW datacenter; why regulation is scary; how to fight a superintelligence "
author: "Jack Clark"
publication: "Import AI"
publication_slug: "importai"
published_at: "2025-11-24T13:31:41.000Z"
...
**Read more:** [OSGym: Super-Scalable Distributed Data Engine for Generalizable Computer Agents (arXiv)](https://arxiv.org/abs/2511.11672).  
**Download OSGym here:** [OSGym (agiopen-org, GitHub)](https://github.com/agiopen-org/osgym).  
...
**Read more:** [AGI is multimodal and reality is the dataset of AGI (Luma AI, blog)](https://lumalabs.ai/blog/news/series-c).  
...
**Read more:** [Over-Regulation is Doubling the Cost (Peter Reinhardt, blog)](https://rein.pk/over-regulation-is-doubling-the-cost).  
...
-   **Global Internet shutdown:** The internet was built to be distributed and resilient, so shutting it down is difficult. But if you wanted to you’d use a few different options:
    ...
    -   **Use the ‘Tier 1 networks’ around the world to coordinate the withdrawal of BGP prefix announcement**s at once which would make nearly the entire internet unreachable.
...
**Read more**: [Evaluating Select Global Technical Options for Countering a Rogue AI (RAND)](https://www.rand.org/pubs/perspectives/PEA4361-1.html).  
