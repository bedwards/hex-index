...
published_at: "2026-01-19T14:03:24.000Z"
...
**Read more:** [Poison Fountain (RNSAFFN)](https://rnsaffn.com/poison3/).  
...
**Read more**: [Framework for a Hypercapable World (AI Prospects: Towards Global Goal Alignment, substack)](https://aiprospects.substack.com/p/options-for-a-hypercapable-world).  
...
**Read more:** [The motivic class of the space of genus 0 maps to the flag variety (arXiv)](https://arxiv.org/abs/2601.07222).  
