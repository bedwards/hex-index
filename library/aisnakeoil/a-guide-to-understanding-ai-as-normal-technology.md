...
published_at: "2025-09-09T13:00:40.000Z"
source_url: "https://www.normaltech.ai/p/a-guide-to-understanding-ai-as-normal"
word_count: 5973
estimated_read_time: 30
---

When we published [AI as Normal Technology](https://knightcolumbia.org/content/ai-as-normal-technology), the impact caught us off guard. It quickly became the most influential thing either of us had ever done.[1](#footnote-1) We took this as a strong signal to spend more of our time thinking and writing about the medium-term future of AI and its impacts, offering grounded analysis of a topic that tends to attract speculation. This is a shift in focus away from writing about the present-day and near-term impacts of AI, which is what the [AI Snake Oil](https://www.normaltech.ai/p/starting-reading-the-ai-snake-oil) project was about.

Reflecting this shift, we have renamed this newsletter. We have already published two [follow-up](https://www.aisnakeoil.com/p/agi-is-not-a-milestone) [essays](https://www.aisnakeoil.com/p/could-ai-slow-science) to AI as Normal Technology and will publish more regularly as we expand our framework into a book, which we plan to complete in late 2026 for publication in 2027.

Today, we address common points of confusion about AI as Normal Technology, try to make the original essay more approachable, and compare it to [AI 2027](https://ai-2027.com/).

**Table of contents**

1.  [Normal doesn’t mean mundane or predictable](https://www.normaltech.ai/i/173147197/normal-doesnt-mean-mundane-or-predictable)
    
2.  [A restatement of our thesis](https://www.normaltech.ai/i/173147197/a-restatement-of-our-thesis)
    
3.  [If disappointment about GPT-5 has nudged you towards AI as normal technology, it’s possible you don’t quite understand the thesis](https://www.normaltech.ai/i/173147197/if-disappointment-about-gpt-has-nudged-you-towards-ai-as-normal-technology-its-possible-you-dont-quite-understand-the-thesis)
    
4.  [Why it’s hard to find a “middle ground” between AI as Normal Technology and AI 2027](https://www.normaltech.ai/i/173147197/why-its-hard-to-find-a-middle-ground-between-ai-as-normal-technology-and-ai)
    
5.  [It is hard to understand one worldview when you’re committed to another](https://www.normaltech.ai/i/173147197/it-is-hard-to-understand-one-worldview-when-youre-committed-to-another)
    
6.  [Reaping AI’s benefits will require hard work and painful choices](https://www.normaltech.ai/i/173147197/reaping-ais-benefits-will-require-hard-work-and-painful-choices)
    
7.  [The surreal debate about the speed of diffusion](https://www.normaltech.ai/i/173147197/the-surreal-debate-about-the-speed-of-diffusion)
    
8.  [Why AI adoption hits different](https://www.normaltech.ai/i/173147197/why-ai-adoption-hits-different)
    
9.  [Concluding thoughts](https://www.normaltech.ai/i/173147197/concluding-thoughts)
...
The development of technical capabilities is more predictable than AI’s social impacts. Daniel Kokotajlo, one of the authors of AI 2027, was previously famous in the AI safety community for his essay “[What 2026 looks like](https://www.lesswrong.com/posts/6Xgy6CAf2jqHhynHL/what-2026-looks-like)” back in 2021. His predictions about the tech itself proved eerily accurate, but the predictions about social impacts were overall not directionally correct, a point he was gracious enough to concede in a podcast discussion with one of us.
...
The best way to understand GPT-5 is that it’s a particularly good example of AI developers’ shift in emphasis from models to products, which we wrote about [a year ago](https://www.aisnakeoil.com/p/ai-companies-are-pivoting-from-creating). The automatic model switcher is a big deal for everyday users of ChatGPT. It turns out that [hardly anyone](https://x.com/sama/status/1954603417252532479) was using “thinking” models nearly a year after they were first released, and GPT-5 has bumped up their use dramatically.

In [some](https://x.com/sama/status/1889755723078443244) communications Altman was clear that the emphasis for GPT-5 was usability, not a leap in capabilities, although this message was unfortunately undercut by the constant hype, leading to disappointment.
...
In fact, model developers are starting to go beyond developing more useful products (the second stage of our technology development & adoption framework) and working with deployers to ease early adoption pains (the third stage). For example, OpenAI’s [Forward Deployed Engineers](https://newsletter.pragmaticengineer.com/p/forward-deployed-engineers) work with customers such as John Deere, and directly with farmers, on integrating and deploying capabilities such as providing personalized recommendations for pesticide application.

## **Why it’s hard to find a “middle ground” between AI as Normal Technology and AI 2027**

Many people have tried to articulate middle ground positions between [AI 2027](https://ai-2027.com/) and AI as Normal Technology, perhaps viewing these as two ends of a spectrum of views.
...
-   Speaking of developing indicators, we are in the process of expanding the vision for our project HAL, [Holistic Agent Leaderboard](https://hal.cs.princeton.edu/). Currently it tries to be a better benchmark orchestration system for AI agents, but the new plan is to develop it into an early warning system that helps the AI community identify when AI agents have crossed capability thresholds for transformative real-world impacts in various domains.  
...
-   Note that HAL is not about prediction; it is about situational awareness of the *present*. This is a theme of our work. What is remarkable about the AI discourse in general, and us versus AI 2027 in particular, is the wide range of views not just about the future but about the things we *can* observe, such as the speed of diffusion (more on that below). Unless we as a community get much better at measurement of the present and [testing competing causal explanations of progress](https://x.com/sayashk/status/1964016339690909847), the level of energy directed at prediction will be misdirected, because we lack ways of resolving those predictions. For example, we’ve argued that we won’t necessarily know if “AGI” has been built [even post facto](https://www.aisnakeoil.com/p/agi-is-not-a-milestone). To some extent these limitations are intrinsic because of the lack of conceptual precision of ideas like AGI, but at the same time it’s true that we can do a lot better at measurement.
...
You can read his full [response](https://blog.ai-futures.org/p/ai-as-profoundly-abnormal-technology) to this in Section 3B of his essay, but in short it focuses on human biological limits:
...
It is worth bearing in mind that advanced AI is entering a world that is already both highly technological and highly regulated. We repeatedly find that the parts of workflows that AI tackles are unlikely to be bottlenecks, because much of the available productivity gains have already been unlocked through earlier waves of technologies. Meanwhile the actual bottlenecks prove resistant due to regulation or other external constraints. In many specific domains including [legal services](https://www.aeaweb.org/articles?id=10.1257/jel.20201330) and [scientific research](https://www.normaltech.ai/p/could-ai-slow-science), competitive dynamics are so strong that productivity gains from AI lead to escalation of arms races that don’t ultimately translate to societal value.
...
For example, almost a year after the vaunted release of “thinking” models in ChatGPT, [less than 1%](https://x.com/sama/status/1954603417252532479) of users used them on any given day! We find no pleasure in pointing this out even though it supports our thesis. As enthusiastic early adopters of AI, this kind of number is so low that it is hard for us to intuitively grasp, and frankly pretty depressing.

Another example of a misleading statistic relates to the fraction of workers in certain high-risk domains who use AI. Such statistics tend to be offered in service of the claim that AI is being rapidly adopted in risky ways. But even in high risk domains most tasks are actually [mundane](https://dho.stanford.edu/wp-content/uploads/Spectrum_AI.pdf), and when we dig into the specific uses don’t seem that risky at all.

For example, a survey by the American Medical Association reported that a majority of [doctors](https://www.ama-assn.org/system/files/physician-ai-sentiment-report.pdf) are using AI. But this includes things like transcription of dictated notes.[5](#footnote-5) It also includes things like asking a chatbot for a second opinion of a diagnosis (about 12% reported this use case in 2024, a whopping 1 percentage point increase from 11% in 2023). This is definitely a more serious use than transcription one, but it is still well-founded. As we’ve pointed out before, even unreliable AI is very helpful for [error](https://journalcrcl.org/crcl/article/view/62/28) [detection](https://www.linkedin.com/posts/randomwalker_error-checking-is-a-great-application-of-activity-7341077466800676866-eFft/).
...
![](https://substackcdn.com/image/fetch/$s_!MLSh!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fd743ae91-ddc4-46f1-a03c-a938b9e9a148_1600x580.png)



](https://substackcdn.com/image/fetch/$s_!MLSh!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fd743ae91-ddc4-46f1-a03c-a938b9e9a148_1600x580.png)

It compares ChatGPT user growth with (1) Instagram, Facebook, and Twitter, which are social media apps whose usefulness depends on network effects, and therefore characteristically grow much slower than apps that are useful from day one (2) Spotify, an app that was initially invite-only and (3) Netflix, a service that launched with a limited inventory and required a subscription to use.[6](#footnote-6)

What is reflected in this chart are early adopters who will check out an app if there’s buzz around it, and there was deafening buzz around ChatGPT. Once you exhaust these curious early users, the growth curve looks very different. In fact, a year later, ChatGPT had apparently only grown [from 100M to 200M](https://www.theverge.com/2024/8/29/24231685/openai-chatgpt-200-million-weekly-users) users, which meant that the curve evidently bent sharply to the right. That is conveniently not captured in this graph which reflects only the first two months.
...
There are many other problems with this chart, but we’ll stop here.[7](#footnote-7) Again, this is far from a complete analysis of the speed of AI diffusion — that’s coming. For now, we’re just making the point that the majority of the commentary on this topic is simply unserious. And if this is what the discourse is like on a question for which we do have data, it is no surprise that *predictions* of the future from different camps bear no resemblance to each other.
...
-   Arvind [presented](https://www.youtube.com/live/CriEhgw6f0k?si=sHp4XIrJ0SY7vKSc&t=19971) the paper at the World Bank Development Conference, focusing on the economic and labor implications.
    
-   [Arvind’s new YouTube channel](https://www.youtube.com/@ArvindOnAI) discusses AI developments based on the normal technology perspective.
    
-   We were fortunate to receive press coverage for AI as Normal Technology:
    
    -   In the last month, the New York Times had three op-eds that discussed the essay in depth, by [Eric Schmidt and Selina Xu](https://www.nytimes.com/2025/08/19/opinion/artificial-general-intelligence-superintelligence.html), by [David Wallace-Wells](https://www.nytimes.com/2025/08/20/opinion/ai-technology-chatgpt.html), and by [Ezra Klein](https://www.nytimes.com/2025/08/24/opinion/chat-gpt5-open-ai-future.html).
        
    -   Last week, the Economist discussed the normal technology thesis in the article "[What if artificial intelligence is just a “normal” technology?](https://www.economist.com/finance-and-economics/2025/09/04/what-if-artificial-intelligence-is-just-a-normal-technology)"
        
    -   In The New Yorker, [Joshua Rothman](https://www.newyorker.com/culture/open-questions/two-paths-for-ai) contrasted AI 2027 with AI as Normal Technology.
        
    -   In Prospect Magazine, [Ethan Zuckerman](https://www.prospectmagazine.co.uk/ideas/technology/70046/ai-isnt-magic.-its-just-weird) discussed the utility of viewing AI as Normal Technology.
        
    -   James O'Donnell, for the MIT Technology Review, [summarized](https://www.technologyreview.com/2025/04/29/1115928/is-ai-normal/) the AI as Normal Technology thesis.
        
-   Some of our podcast appearances include: Arvind on New York Times' [Hard Fork](https://podcasts.apple.com/us/podcast/meta-on-trial-is-a-i-a-normal-technology-hatgpt/id1528594034?i=1000703985596), and [Tim O’Reilly’s podcast](https://www.oreilly.com/radar/is-ai-a-normal-technology/); Sayash on Lawfare's [Scaling Laws](https://www.youtube.com/watch?v=mpmi-l-G-wI) and Carnegie's [Interpreting India](https://carnegieendowment.org/podcasts/interpreting-india/beyond-superintelligence-a-realists-guide-to-ai?utm_source=chatgpt.com).
    
-   We have had conversations with many people who have the superintelligence worldview, including many of the authors of AI 2027: Sayash debated [Daniel Kokotajlo](https://www.youtube.com/watch?v=rVFAJQryzk8) and [Eli Lifland](https://x.com/i/broadcasts/1mrGmPeorrNKy); Arvind debated [Daniel Kokotajlo](https://www.youtube.com/watch?v=2hby15Z3uXA), and in [Asterisk Mag](https://asteriskmag.com/issues/10/does-ai-progress-have-a-speed-limit?utm_source=chatgpt.com), Arvind and Ajeya Cotra debated whether AI progress has a speed limit, and how we’d know.
    

[1](#footnote-anchor-1)

As is so often the case, fortuitous timing played a big role in the success of the essay. It was released two weeks after AI 2027, but this was purely by coincidence — our publication date was actually based on the Knight Institute symposium on [AI and Democratic Freedoms](https://knightcolumbia.org/events/artificial-intelligence-and-democratic-freedoms). We are grateful to the Institute for the opportunity to publish the essay.

[2](#footnote-anchor-2)

Mental health issues with chatbots in general, and problems such as addiction, have been widely recognized and discussed, including in our book [AI Snake Oil](https://www.amazon.com/Snake-Oil-Artificial-Intelligence-Difference/dp/069124913X). These tend to be based on an analogy with social media. But it's one thing to anticipate the potential for mental health impacts, and another to predict specifically what impacts might emerge and how to avoid them.
...
The framework is adapted from the [classic diffusion-of-innovations theory](https://www.simonandschuster.com/books/Diffusion-of-Innovations-5th-Edition/Everett-M-Rogers/9780743258234) and also influenced by recent writers such as Jeffrey Ding who have [analyzed](https://press.princeton.edu/books/paperback/9780691260341/technology-and-the-rise-of-great-powers) geopolitical competition in AI through the lens of the innovation-diffusion gap.
