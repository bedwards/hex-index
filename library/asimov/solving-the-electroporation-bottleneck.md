---
title: "Solving the Electroporation Bottleneck"
author: "Niko McCarty"
publication: ""
publication_slug: "asimov"
published_at: "2026-01-15T11:56:32.000Z"
source_url: "https://www.asimov.press/p/electroporation"
word_count: 2613
...
![](https://substackcdn.com/image/fetch/$s_!Poww!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F43a64079-8c66-43be-98bb-2cf9b1786b2c_2000x1260.jpeg)



](https://substackcdn.com/image/fetch/$s_!Poww!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F43a64079-8c66-43be-98bb-2cf9b1786b2c_2000x1260.jpeg)

Science’s most studied organism is, without contest, *E. coli*. It has prompted at least half a million academic papers, spanning nearly a century of work. And yet a quarter of its genes still do not have an experimentally-determined function, according to a [2019 study](https://pmc.ncbi.nlm.nih.gov/articles/PMC6412132/).[1](#footnote-1)
...
Scientists have estimated that about one trillion microbial species inhabit the Earth, of which 99.999 percent remain undiscovered.[2](#footnote-2) Of those that have been cataloged, perhaps a few thousand have been grown in a laboratory. In other words, a vast chasm remains between the microbes one can see under a microscope or locate in the dirt and those we can grow on a petri dish.[3](#footnote-3) Rounding to the nearest whole number, we have deeply studied zero percent of lifeforms on this planet.
...
Another reason is that the combinatorial complexity of biology is vast and difficult to navigate. A typical protein in *E. coli* is 300 amino acids long, with 20 possible amino acids at each position. The number of possible sequences for this hypothetical protein is thus 20300, more options than there are atoms in the Universe. And that’s just for proteins![4](#footnote-4)
...
Now it should be clearer why making headway in the biology lab is so difficult. As it so happens, this is exactly the problem that [Cultivarium](https://www.cultivarium.org/), a nonprofit research organization, is trying to solve. For a recent study, they created a robot that finds working conditions to both grow and engineer non-model microbes. They are giving these growth protocols away for free, in the hopes that others will use them and begin studying a wider range of lifeforms on Earth.

[

![](https://substackcdn.com/image/fetch/$s_!GX4K!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fda6d7835-b555-404a-819c-6bf07ebe0858_4032x3024.jpeg)



](https://substackcdn.com/image/fetch/$s_!GX4K!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fda6d7835-b555-404a-819c-6bf07ebe0858_4032x3024.jpeg)
*The Cultivarium space in Watertown, Massachusetts.*
...
![](https://substackcdn.com/image/fetch/$s_!OWYW!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fc1da7567-2e19-4850-a90c-c750f9fd245e_1954x962.png)



](https://substackcdn.com/image/fetch/$s_!OWYW!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fc1da7567-2e19-4850-a90c-c750f9fd245e_1954x962.png)
*How electroporation works. Cells are placed in a cuvette along with the DNA. Pulses of electricity open pores in the cells’ membranes, allowing DNA to slip inside.*
...
So Neumann, ever the tinkerer, found a tube of frozen mouse fibroblast cells deficient in thymidine kinase, an enzyme required for DNA synthesis. These cells die in HAT medium, a selective liquid that only allows cells with a functional form of this enzyme to survive and grow. First, Neumann created a plasmid carrying the thymidine kinase gene. Next, he performed several trials, trying many different parameters to [push this thymidine kinase gene into these deficient cells](https://pubmed.ncbi.nlm.nih.gov/6329708/). He tuned the electrical field strength, pulse durations, temperature, and so on. Finally, he found settings that worked: out of one million cells in the shocked vial, 95 took up the plasmid and grew. The cells that took up the DNA regained the thymidine kinase gene, made the enzyme, and thus survived in HAT. Neumann called his method “electroporation.”[5](#footnote-5)
...
The total space of parameters for a single electroporation experiment is vast. One commercially available electroporator machine, called the [BTX Gemini X2](https://btxonline.com/gemini-twin-wave-electroporators-2313.html), has more than 4.2 million possible settings for voltage, resistance, and capacitance. And this doesn’t even include biological variables, like the buffer in which cells are washed, pH levels, or temperature.

[

![](https://substackcdn.com/image/fetch/$s_!jx1C!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F12444268-722f-47bb-a3a0-a090dfe12994_636x636.gif)



](https://substackcdn.com/image/fetch/$s_!jx1C!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F12444268-722f-47bb-a3a0-a090dfe12994_636x636.gif)
*Electroporation parameters include voltage, buffer pH, temperature, and much more. The true space of possibilities is not three-dimensional, as depicted here, but vastly more complex.*
...
This time-consuming procedure inspired Cultivarium to [automate the process](https://www.biorxiv.org/content/10.1101/2025.11.18.689155v1.full.pdf). As opposed to a human painstakingly choosing parameters and filling the cuvettes, they built a custom electroporator robot that clamps down onto a 96-well plate and can deliver different electrical pulses to each well. Every well can also have different buffers and DNA concentrations. The machine is controlled through an API, and the team can test 24 different conditions simultaneously in a single run. (The device isn’t yet for sale and Cultivarium has not released the blueprints. They also declined a request to share a photograph of the robot, citing biosecurity concerns.)
...
![](https://substackcdn.com/image/fetch/$s_!Hcqf!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F4380dd8c-59a2-4ea3-81e7-a8f16d6010ca_1448x1505.png)



](https://substackcdn.com/image/fetch/$s_!Hcqf!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F4380dd8c-59a2-4ea3-81e7-a8f16d6010ca_1448x1505.png)
*Results for two types of microbes. Each microbe was transformed using different buffers (sucrose, sorbitol, water, or glycerol) at distinct voltages, from 0 to 6 kV. Credit: [Brumwell S.L.](https://www.biorxiv.org/content/10.1101/2025.11.18.689155v1.full) *[et al.](https://www.biorxiv.org/content/10.1101/2025.11.18.689155v1.full)* (2025)*
...
I’ve [profiled Cultivarium](https://press.asimov.com/articles/cultivarium) before, and my doing so again is a first. But their work feels deeply important because it is by tinkering with non-model organisms that biotechnologists have, historically, found the most useful tools.
...
From here, the scientists could try and synthesize the plastic-eating genes and put them into another microbe, like *E. coli*, that is easier to work with. This is basically the logic of metagenomics: sequence environmental samples, identify interesting genes computationally, and express them in a more cooperative host. This approach was recently used to discover [Bridge recombinases](https://www.nmccarty.com/p/bridge-editors), a new type of genome-editing tool.
...
Specifically, the researchers identified 1,600 out of 4,623 unique genes — what they termed the “y-ome” — that lack direct, experimental evidence of a function. I’ve not seen an updated count, but presumably the gap has closed quite a bit over the last six years.

[2](#footnote-anchor-2)

Researchers made this estimate using mathematical scaling laws; with a database of 5.6 million species from 35,000 locations, they extrapolated to predict the abundance and diversity of organisms elsewhere.

[3](#footnote-anchor-3)

This has frustrated microbiologists for decades, actually. In 1985, James T. Staley and Allan Konopka noted that they were only able to recover about one percent of bacteria from a sample; they dubbed this the “[Great Plate Count Anomaly](https://www.annualreviews.org/content/journals/10.1146/annurev.mi.39.100185.001541).”

[4](#footnote-anchor-4)

Admittedly, if we envision the total space of “protein possibilities” as a handkerchief, the protein sequences likely to yield a functional, folded protein would probably only make up a few threads in that fabric.

[5](#footnote-anchor-5)

8 kV/cm field strength, 5 microsecond pulse, 3 pulses with 3 seconds between pulses, 20 °C temperature, and no magnesium chloride!