...
log "Running weekly epub generation..."
npx tsx tools/static-site/generate.ts --only weekly 2>&1 | tee -a "$LOG_FILE"
log "Skipping deploy — handled by Claude monitoring loop"
